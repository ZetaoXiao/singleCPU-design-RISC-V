...
-- Date        : Wed Jul 14 23:42:15 2021
-- Host        : 612-34 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/Administrator/Desktop/singlecpu/SingleCPU.srcs/sources_1/ip/prgrom/prgrom_sim_netlist.vhdl
-- Design      : prgrom
...
architecture STRUCTURE of prgrom_dist_mem_gen_v8_0_12 is
  ...
  signal \^spo\ : STD_LOGIC_VECTOR ( 23 downto 7 );
begin
  dpo(31) <= \<const0>\;
  dpo(30) <= \<const0>\;
  dpo(29) <= \<const0>\;
...
\synth_options.dist_mem_inst\: entity work.prgrom_dist_mem_gen_v8_0_12_synth
     port map (
      a(13 downto 0) => a(13 downto 0),
      spo(4 downto 1) => \^spo\(23 downto 20),
      spo(0) => \^spo\(7)
    );
end STRUCTURE;
library IEEE;
